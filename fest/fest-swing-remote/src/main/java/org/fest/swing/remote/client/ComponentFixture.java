...
public abstract class ComponentFixture<T extends Component> {
   ...
   */
  public ComponentFixture(Connection connection, String name, Class<T> type) {
    this.connection = connection;
    findComponentByName(name, type);
  }

  private void findComponentByName(String name, Class<T> type) {
    Response response = connection.send(findByName(name, type));
