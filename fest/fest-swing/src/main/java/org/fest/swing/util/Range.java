...
public final class Range {
  ...
  /**
   * Creates a new <code>{@link From}</code>, representing the start of a range.
  ...
  /**
   * Creates a new <code>{@link To}</code>, representing the end of a range.
  ...
  /**
   * Understands the start of a range.
   *
   * @author Alex Ruiz
   */
  ...
  /**
   * Understands the end of a range.
   *
   * @author Alex Ruiz
   */
