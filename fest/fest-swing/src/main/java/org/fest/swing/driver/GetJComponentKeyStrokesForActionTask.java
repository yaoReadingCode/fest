...
class GetJComponentKeyStrokesForActionTask extends GuiTask<KeyStroke[]> {
  ...
  static KeyStroke[] keyStrokesForAction(JComponent component, String actionName) {
    return new GetJComponentKeyStrokesForActionTask(component, actionName).run();
  }
  
  private GetJComponentKeyStrokesForActionTask(JComponent component, String actionName) {
