 ...
 * @author Alex Ruiz
 */
class IsJComboBoxEditorAccessibleTask extends GuiQuery<Boolean> {
  
  private final JComboBox comboBox;

  static boolean isEditorAccessible(JComboBox comboBox) {
    return new IsJComboBoxEditorAccessibleTask(comboBox).run();
  }
  
  private IsJComboBoxEditorAccessibleTask(JComboBox comboBox) {
