 ...
 * @author Yvonne Wang
 */
class IsJInternalFrameClosableTask extends GuiQuery<Boolean> {

  private final JInternalFrame internalFrame;

  static boolean isClosable(JInternalFrame internalFrame) {
    return new IsJInternalFrameClosableTask(internalFrame).run();
  }

  private IsJInternalFrameClosableTask(JInternalFrame internalFrame) {
