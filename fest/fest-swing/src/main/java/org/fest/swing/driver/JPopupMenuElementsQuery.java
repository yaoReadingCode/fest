 ...
 * @see JPopupMenu#getSubElements()
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
final class JPopupMenuElementsQuery {

  static MenuElement[] elementsOf(final JPopupMenu popupMenu) {
  ...
  private JPopupMenuElementsQuery() {}
}