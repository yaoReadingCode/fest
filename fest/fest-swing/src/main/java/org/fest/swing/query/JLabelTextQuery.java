 ...
 * @author Yvonne Wang
 */
public final class JLabelTextQuery extends GuiQuery<String> {
  ...
  /**
   * Returns the text in this query's <code>{@link JLabel}</code>. This action is executed in the event dispatch thread.
   * @return the text in this query's <code>JLabel</code>.
   */
