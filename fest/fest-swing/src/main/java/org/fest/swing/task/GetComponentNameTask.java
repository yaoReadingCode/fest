...
public final class GetComponentNameTask extends GuiTask<String> {
  ...
  public static String nameOf(Component component) {
    return new GetComponentNameTask(component).run();
  }
  
  private GetComponentNameTask(Component component) {
    this.component = component;
  }

  /**
   * Returns the name in this task's <code>{@link Component}</code>. This action is executed in the event dispatch 
   * thread.
   * @return the name in this task's <code>Component</code>.
   */
