 ...
 * @author Yvonne Wang
 */
class GetJListElementAtIndexTask extends GuiQuery<Object> {

  private final JList list;
  private final int index;

  static Object elementAt(JList list, int index) {
    return new GetJListElementAtIndexTask(list, index).run();
  }

  private GetJListElementAtIndexTask(JList list, int index) {
    this.list = list;
    this.index = index;
  }
