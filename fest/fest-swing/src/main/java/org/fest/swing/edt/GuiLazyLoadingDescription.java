...
/**
 * Understands a <code>{@link LazyLoadingDescription}</code> that loads the text to return in the event dispatch thread.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public abstract class GuiLazyLoadingDescription implements LazyLoadingDescription {
