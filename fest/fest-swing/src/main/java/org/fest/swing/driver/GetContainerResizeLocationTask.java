 ...
 * @author Alex Ruiz
 */
class GetContainerResizeLocationTask extends GuiQuery<Point> {

  private final Container container;

  static Point resizeLocationOf(Container container) {
    return new GetContainerResizeLocationTask(container).run();
  }
  
  private GetContainerResizeLocationTask(Container container) {
