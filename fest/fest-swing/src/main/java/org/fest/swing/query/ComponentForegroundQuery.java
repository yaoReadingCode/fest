 ...
 * @author Yvonne Wang
 */
public final class ComponentForegroundQuery extends GuiQuery<Color> {
  ...
  public static Color foregroundOf(Component component) {
    return execute(new ComponentForegroundQuery(component));
  }

  ComponentForegroundQuery(Component component) {
    this.component = component;
  }

  /**
   * Returns the foreground color of this query's <code>{@link Component}</code>. This action is executed in the event
   * dispatch thread.
   * @return the foreground color of this query's <code>Component</code>.
   */
