 ...
 * @author Yvonne Wang
 */
class IsJInternalFrameMaximizableTask extends GuiQuery<Boolean> {

  private final JInternalFrame internalFrame;

  static boolean isMaximizable(JInternalFrame internalFrame) {
    return new IsJInternalFrameMaximizableTask(internalFrame).run();
  }

  private IsJInternalFrameMaximizableTask(JInternalFrame internalFrame) {
