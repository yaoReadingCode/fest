...
/**
 * Tests for <code>{@link GetJInternalFrameDesktopIconTask}</code>.
 *
 * @author Yvonne Wang
 */
@Test public class GetJInternalFrameDesktopIconTaskTest {
  ...
  public void shouldCloseJInternalFrame() {
    new EasyMockTemplate(internalFrame) {
      ...
      protected void codeToTest() {
        assertThat(GetJInternalFrameDesktopIconTask.desktopIconOf(internalFrame)).isSameAs(desktopIcon);
      }
    }.run();
  }
}
