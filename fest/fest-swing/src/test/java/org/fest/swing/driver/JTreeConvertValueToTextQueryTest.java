...
public class JTreeConvertValueToTextQueryTest {
  ...
  private String text;
  private JTreeConvertValueToTextQuery query;

  @BeforeMethod public void setUp() {
    tree = createMock(JTree.class);
    value = new Object();
    text = "Hello";
    query = new JTreeConvertValueToTextQuery(tree, value);
  }

  public void shouldIndicateIfPathExpanded() {
    new EasyMockTemplate(tree) {
      protected void expectations() {
        expect(tree.convertValueToText(value, false, false, false, 0, false)).andReturn(text);
      }
