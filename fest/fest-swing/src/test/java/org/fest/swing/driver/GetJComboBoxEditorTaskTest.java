...
/**
 * Tests for <code>{@link GetJComboBoxEditorTask}</code>.
 *
 * @author Alex Ruiz
 */
@Test public class GetJComboBoxEditorTaskTest {
  ...
  public void shouldReturnEditorComponentFromJComboBox() {
    new EasyMockTemplate(comboBox, editor) {
      ...
      protected void codeToTest() {
        assertThat(GetJComboBoxEditorTask.editorOf(comboBox)).isSameAs(editorComponent);
      }
    }.run();
  }
}
