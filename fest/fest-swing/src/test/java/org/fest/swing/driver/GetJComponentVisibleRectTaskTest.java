...
/**
 * Tests for <code>{@link GetJComponentVisibleRectTask}</code>.
 *
 * @author Alex Ruiz
 */
@Test public class GetJComponentVisibleRectTaskTest {
  ...
  public void shouldReturnVisibleRectOfJComponent() {
    new EasyMockTemplate(component) {
      ...
      protected void codeToTest() {
        assertThat(GetJComponentVisibleRectTask.visibleRectOf(component)).isSameAs(rectangle);
      }
    }.run();
  }
}
