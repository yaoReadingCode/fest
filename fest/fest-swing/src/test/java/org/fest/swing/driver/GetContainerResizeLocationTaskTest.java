...
/**
 * Tests for <code>{@link GetContainerResizeLocationTask}</code>.
 *
 * @author Alex Ruiz
 */
@Test public class GetContainerResizeLocationTaskTest {
  ...
  public void shouldReturnResizeLocationOfContainer() {
    new EasyMockTemplate(container) {
      ...
      protected void codeToTest() {
        Point resizeLocation = GetContainerResizeLocationTask.resizeLocationOf(container);
