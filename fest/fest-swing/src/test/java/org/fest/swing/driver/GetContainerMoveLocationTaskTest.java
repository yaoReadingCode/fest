...
/**
 * Tests for <code>{@link GetContainerMoveLocationTask}</code>.
 *
 * @author Alex Ruiz
 */
@Test public class GetContainerMoveLocationTaskTest {
  ...
  public void shouldReturnMoveLocationOfContainer() {
    new EasyMockTemplate(container) {
      ...
      protected void codeToTest() {
        Point moveLocation = GetContainerMoveLocationTask.moveLocationOf(container);
