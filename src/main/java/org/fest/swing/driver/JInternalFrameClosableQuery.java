 ...
 * @see JInternalFrame#isClosable()
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
final class JInternalFrameClosableQuery {

  static boolean isClosable(final JInternalFrame internalFrame) {
  ...
  private JInternalFrameClosableQuery() {}
}