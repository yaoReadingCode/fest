...
import org.fest.swing.assertions.Commons;
...
public class CommonsTest {
  ...
  @Test public void shouldReturnPathFromGivenPackageName() {
    String expected = "org" + separator + "fest" + separator + "swing" + separator;
    assertThat(Commons.packageNameAsPath("org.fest.swing")).isEqualTo(expected);
  }
  
  @Test public void shouldReturnPathFromPackageOfGivenClass() {
    Class<?> c = getClass();
    String expected = "org" + separator + "fest" + separator + "swing" + separator + "assertions" + separator;
